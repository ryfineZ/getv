...
var init_config = __esm({
  "node_modules/@opennextjs/aws/dist/adapters/config/index.js"() {
    ...
    FunctionsConfigManifest = { "version": 1, "functions": { "/api/download": { "maxDuration": 300 } } };
